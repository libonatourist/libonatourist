...
<head>
    ...
    <title><?php echo e($category->name); ?>; Libona Tour</title>
    ...
    <link rel="alternate" type="application/rss+xml" title="Libona Tour &raquo; Farm Category Feed"
        href="https://libonatour.x10.mx/listing-category/farm/feed/" />
    ...
    <style id='wp-carousel-free-inline-css' type='text/css'>
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .wpcp-single-item {
            border: 1px solid #dddddd;
        }

        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-prev,
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-next,
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-prev:hover,
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-next:hover {
            background: none;
            border: none;
            font-size: 30px;
        }

        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-prev i,
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-next i {
            color: #aaa;
        }

        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-prev i:hover,
        #sp-wp-carousel-free-id-436.sp-wpcp-436 .swiper-button-next i:hover {
            color: #178087;
        }

        #sp-wp-carousel-free-id-436.sp-wpcp-436 .wpcp-swiper-dots .swiper-pagination-bullet {
            background-color: #cccccc;
        }

        #sp-wp-carousel-free-id-436.sp-wpcp-436 .wpcp-swiper-dots .swiper-pagination-bullet.swiper-pagination-bullet-active {
            background-color: #178087;
        }

        @media screen and (max-width: 479px) {
            #sp-wp-carousel-free-id-436.nav-vertical-center {
                padding: 0;
                margin: 0;
            }

            #sp-wp-carousel-free-id-436.nav-vertical-center .wpcp-next-button,
            #sp-wp-carousel-free-id-436.nav-vertical-center .wpcp-prev-button {
                display: none;
            }
        }

        #sp-wp-carousel-free-id-436 .wpcpro-row>[class*="wpcpro-col-"] {
            padding: 0 10px;
            padding-bottom: 20px;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .wpcp-single-item {
            border: 1px solid #dddddd;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-prev,
        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-next,
        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-prev:hover,
        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-next:hover {
            background: none;
            border: none;
            font-size: 30px;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-prev i,
        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-next i {
            color: #aaa;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-prev i:hover,
        #sp-wp-carousel-free-id-445.sp-wpcp-445 .swiper-button-next i:hover {
            color: #178087;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .wpcp-swiper-dots .swiper-pagination-bullet {
            background-color: #cccccc;
        }

        #sp-wp-carousel-free-id-445.sp-wpcp-445 .wpcp-swiper-dots .swiper-pagination-bullet.swiper-pagination-bullet-active {
            background-color: #178087;
        }

        @media screen and (max-width: 479px) {
            #sp-wp-carousel-free-id-445.nav-vertical-center {
                padding: 0;
                margin: 0;
            }

            #sp-wp-carousel-free-id-445.nav-vertical-center .wpcp-next-button,
            #sp-wp-carousel-free-id-445.nav-vertical-center .wpcp-prev-button {
                display: none;
            }
        }

        #sp-wp-carousel-free-id-445 .wpcpro-row>[class*="wpcpro-col-"] {
            padding: 0 10px;
            padding-bottom: 20px;
        }
    ...
    <link rel="alternate" type="application/json"
        href="https://libonatour.x10.mx/wp-json/wp/v2/listing_category/75" />
...
<body
    class="archive tax-listing_category term-farm term-75 theme-listeo woocommerce-no-js hfeed user_not_logged_in solid-header full-width-header listeo elementor-default elementor-kit-309">
            ...
            <div class="fs-inner-container content">
                <div class="fs-content">
                    ...
                    <section class="search">
                        <a href="#" id="show-map-button" class="show-map-button" data-enabled="Show Map "
                            data-disabled="Hide Map ">Show Map </a>
                        <div class="row">
                            <div class="col-md-12">

                                <form action="" id="listeo_core-search-form"
                                    class="listeo-form-search_on_half_map dynamic    ajax-search" method="GET">
                                    <div class="row with-forms">
                                        ...
                                        <div class="row">
                                            <div class="col-fs-15 panel-wrapper">
                                                <!-- Panel Dropdown -->
                    ...
                    <section class="listings-container margin-top-45">
                        ...
                        <div class="row fs-listings">
                            ...
                            <!-- Listings -->
                            <div data-grid_columns="2" data-region="" data-category="farm" data-feature=""
                                data-service-category="" data-rental-category="" data-event-category=""
                                data-orderby="featured" data-style="list" class="listings-container list-layout"
                                ...
                                <?php $__currentLoopData = $places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-lg-12 col-md-12">
                                        <div class="listing-item-container listing-geo-data  list-layout listing-type-service"
                                            data-title="<?php echo e($place->name); ?>"
                                            data-listing-type="<?php echo e($place->category->name); ?>"
                                            data-classifieds-price="$" data-friendly-address="<?php echo e($place->address); ?>"
                                            data-address="<?php echo e($place->address); ?>"
                                            data-image="<?php echo e(asset('uploads/places/' . $place->images[0]->image_url)); ?>"
                                            data-longitude="<?php echo e($place->latitude); ?>"
                                            data-latitude="<?php echo e($place->longitude); ?>" data-rating="" data-reviews="0"
                                            data-icon="<?php if($place->category_id == 1): ?> <?php echo e(\App\Enums\CategoryIcons::Icon1); ?>
                                        ...
                                        <?php echo e(\App\Enums\CategoryIcons::Icon5); ?> <?php endif; ?>">
                                            <a href="<?php echo e(route('place.details', ['id' => $place->id])); ?>"
                                                class="listing-item featured-listing">
                                                ...
                                                <div class="listing-item-image">
                                                    <img width="520" height="397"
                                                        src="<?php echo e(asset('uploads/places/' . $place->images[0]->image_url)); ?>"
                                                        class="attachment-listeo-listing-grid size-listeo-listing-grid wp-post-image"
                                                        alt="" decoding="async" fetchpriority="high" /> <span
                                                        class="tag">
                            ...
                            <div class="copyrights margin-top-0">© Libona Tourist Spots. All Rights Reserved.
                            </div>
                        </div>
                    </section>
...
<?php /**PATH C:\Users\Administrator\Desktop\projects\laravel_project\touring\tour\resources\views/frond-end/category.blade.php ENDPATH**/ ?>