                                                    ...
                                                    <a href="<?php echo e(route('category', $category->id)); ?>"
                                                        ...
                                                        <i class="listeo-svg-icon-box-grid">
                                                            ...
                                                            <?php if($category->id == 1): ?>
                                                                <?php echo \App\Enums\CategoryIcons::Icon1; ?>

                                                            <?php elseif($category->id == 2): ?>
                                                                <?php echo \App\Enums\CategoryIcons::Icon2; ?>

                                                            <?php elseif($category->id == 3): ?>
                                                                <?php echo \App\Enums\CategoryIcons::Icon3; ?>

                                                            <?php elseif($category->id == 4): ?>
                                                                <?php echo \App\Enums\CategoryIcons::Icon4; ?>

                                                            <?php else: ?>
                                                                <?php echo \App\Enums\CategoryIcons::Icon5; ?>
                                                        ...
                                                        <span class="category-box-counter">
                                                            <?php echo e($category->place->count()); ?>
                                                ...
                                                <?php $__currentLoopData = $places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="fw-carousel-item">
                                                        ...
                                                        <a href="<?php echo e(route('place.details', ['id' => $place->id])); ?>"
                                                            ...
                                                            data-longitude="<?php echo e($place->longitude); ?>"
                                                            data-latitude="<?php echo e($place->latitude); ?>" data-rating="0"
                                                            data-reviews="0">
...
<?php /**PATH C:\Users\Administrator\Desktop\projects\laravel_project\touring\tour\resources\views/frond-end/home.blade.php ENDPATH**/ ?>