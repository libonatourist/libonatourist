            ...
            <div class="left-side">
                ...
                <nav id="navigation" class="style-1">
                    <ul id="responsive" class="menu">
                        <li
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home @if (request()->route()->named('home')) current-menu-item @endif page_item page-item-114 current_page_item menu-item-229 parentid0 depth0 dropdown">
                            <a href="/">Home</a>
                        </li>
                        <li
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-222 parentid0 depth0 dropdown @if (request()->route()->named('places')) current-menu-item @endif">
                            <a href="{{ route('places') }}">Places to Go</a>
                        </li>
                        <li
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-686 parentid0 depth0 dropdown @if (request()->route()->named('about')) current-menu-item @endif">
