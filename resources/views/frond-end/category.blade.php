...
<head>
    ...
    <title>{{ $category->name }}; Libona Tour</title>
                                ...
                                @foreach ($places as $place)
                                    <div class="col-lg-12 col-md-12">
                                        <div class="listing-item-container listing-geo-data  list-layout listing-type-service"
                                            ...
                                            data-listing-type="{{ $place->category->name }}"
                                            data-classifieds-price="$" data-friendly-address="{{ $place->address }}"
                                            data-address="{{ $place->address }}"
                                            data-image="{{ asset('uploads/places/' . $place->images[0]->image_url) }}"
                                            data-longitude="{{ $place->latitude }}"
                                            data-latitude="{{ $place->longitude }}" data-rating="" data-reviews="0"
                                            data-icon="@if ($place->category_id == 1) {{ \App\Enums\CategoryIcons::Icon1 }}
                                        ...
                                        @else
                                        {{ \App\Enums\CategoryIcons::Icon5 }} @endif">
