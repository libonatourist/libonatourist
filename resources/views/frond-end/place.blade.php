...
<head>
    ...
    <title>{{ $place->name }} - Libona Tour</title>
...
================================================== -->
        ...
        <div class="listing-slider mfp-gallery-container margin-bottom-0">
            @foreach ($place->images as $placeImage)
                <a href="{{ asset('uploads/places/' . $placeImage->image_url) }}"
                    data-background-image="{{ asset('uploads/places/' . $placeImage->image_url) }}"
   ...
   ================================================== -->
			...
			"slidesToShow":{"lg_desktop":2, "desktop": 2, "laptop": 2, "tablet": 1, "mobile": 1}, "responsive":{"desktop":1200, "laptop": 980, "tablet": 736, "mobile": 480}, "rtl":false, "lazyLoad": "false", "swipe": true, "draggable": true, "swipeToSlide":false }'
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="wpcp-single-item">
                                                            <a class="wcp-light-box" data-buttons='["close"]'
                                                                data-wpc_url='{{ asset('uploads/places/' . $placeImage->image_url) }}'
                                                                href="{{ asset('uploads/places/' . $placeImage->image_url) }}"
                                                                data-fancybox="wpcp_view">
                                                                <figure>
                                                                    <img class="skip-lazy"
                                                                        src="{{ asset('uploads/places/' . $placeImage->image_url) }}"
                        ...
                        <p style="text-align: center;"><a
                                ...
                                href="{{ route('place.360view', $place->id) }}">View
                                360°</a>&nbsp; &nbsp; &nbsp;<a
                                class="fasc-button fasc-size-large fasc-type-glossy fasc-rounded-medium fasc-style-italic"
                                style="background-color: #33809e; color: #ffffff;"
                                href="{{ asset('uploads/guidelines/' . $place->guideline) }}">Guidelines</a></p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p></p>
                        <div class="clearfix"></div>
                        ...
                        <div id="listing-location" class="listing-section">
                            ...
                            <div id="singleListingMap-container" class=" ">
                                <div id="singleListingMap" data-latitude="{{ $place->latitude }}"
                                    data-longitude="{{ $place->longitude }}" data-map-icon="empty"
                                    data-map-icon-svg="@if ($place->category_id == 1) {{ \App\Enums\CategoryIcons::Icon1 }}
                                ...
                                <a target="_blank"
                                    href="{{ url('https://www.google.com/maps/dir/?api=1&destination=' . $place->latitude . ',' . $place->longitude) }}"
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-4 text-center">
                                                ...
                                                <h3><span id="total_review">{{ $place->reviews->count() }}</span>
                                                    Review</h3>
                                            </div>
                                            <div class="col-sm-4">
                                                <p>
                                                ...
                                                <div class="progress-label-right">(<span
                                                        id="total_five_star_review">{{ $place->reviews->where('rating', 5)->count() }}</span>)
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                        aria-valuenow="{{ $place->reviews->where('rating', 5)->count() }}"
                                                ...
                                                <div class="progress-label-right">(<span
                                                        id="total_four_star_review">{{ $place->reviews->where('rating', 4)->count() }}</span>)
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                        aria-valuenow="{{ $place->reviews->where('rating', 4)->count() }}"
                                                        aria-valuemin="0" aria-valuemax="100"
                                                ...
                                                <div class="progress-label-right">(<span
                                                        id="total_three_star_review">{{ $place->reviews->where('rating', 3)->count() }}</span>)
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                ...
                                                <div class="progress-label-right">(<span
                                                        id="total_two_star_review">{{ $place->reviews->where('rating', 2)->count() }}</span>)
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                                ...
                                                <div class="progress-label-right">(<span
                                                        id="total_one_star_review">{{ $place->reviews->where('rating', 1)->count() }}</span>)
                                                </div>
                                                <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar"
                                                        aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-footer text-right">
                                                        {{ date('l jS \of F Y h:i:s A', strtotime($review->created_at)) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                @if (auth()->check() == true && auth()->user()->is_admin == false)
                    <form action="{{ route('place.details', $place->id) }}" method="post">
                        @csrf
...
<script>
    $(document).ready(function() {
        ...
        var fiveReviews = {{ $place->reviews->where('rating', 5)->count() }}
        var fourReviews = {{ $place->reviews->where('rating', 4)->count() }}
        var threeReviews = {{ $place->reviews->where('rating', 3)->count() }}
        var twoReviews = {{ $place->reviews->where('rating', 2)->count() }}
        var oneReviews = {{ $place->reviews->where('rating', 1)->count() }}
